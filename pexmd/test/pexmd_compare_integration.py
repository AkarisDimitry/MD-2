...
step = 20
data = [np.zeros( (223, 4) ) ,np.zeros( (500, 4) ), np.zeros( (500, 4) )]
Fdata = [np.zeros( (223, 4) ) ,np.zeros( (500, 4) ), np.zeros( (500, 4) )]
Edata = [np.zeros( (223,4,3) ), np.zeros( (500, 4, 3) ), np.zeros( (500, 4, 3) )]
...
for i, n in enumerate([0.05,0.02,0.01]):
    ...
    while var00 < steps:
        ...
        #print time.clock()-t1
        data[i][var00, 0] += time.clock()-t1
        Edata[i][var00,0,0] = E
        Edata[i][var00,0,1] = np.sum(sistema00.v**2) / 2
        Edata[i][var00,0,2] = E + np.sum(sistema00.v**2) / 2
    ...
    while var00 < steps:
        ...
        data[i][var00,1] += time.clock() - t1
        Edata[i][var00,1,0] = E
        Edata[i][var00,1,1] = np.sum(sistema01.v**2) / 2
        Edata[i][var00,1,2] = E + np.sum(sistema01.v**2) / 2
    ...
    while var00 < steps:
        ...
        data[i][var00,2] += time.clock() - t1
        Edata[i][var00,2,0] = E
        Edata[i][var00,2,1] = np.sum(sistema02.v**2) / 2
        Edata[i][var00,2,2] = E + np.sum(sistema02.v**2) / 2
    ...
    while var00 < steps:
        ...
        data[i][var00,3] += time.clock() - t1
        Edata[i][var00,3,0] = E
        Edata[i][var00,3,1] = np.sum(sistema03.v**2) / 2
        Edata[i][var00,3,2] = E + np.sum(sistema03.v**2) / 2
